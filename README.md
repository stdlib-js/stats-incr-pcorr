...
```javascript
incrpcorr = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-incr-pcorr@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/stats-incr-pcorr/tags). For example,

```javascript
incrpcorr = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-incr-pcorr@v0.2.3-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var incrpcorr = require( 'path/to/vendor/umd/stats-incr-pcorr/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-incr-pcorr@umd/browser.js"></script>
```
...
[test-image]: https://github.com/stdlib-js/stats-incr-pcorr/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/stats-incr-pcorr/actions/workflows/test.yml?query=branch:v0.2.3
...
[deno-readme]: https://github.com/stdlib-js/stats-incr-pcorr/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/stats-incr-pcorr/tree/umd
[umd-readme]: https://github.com/stdlib-js/stats-incr-pcorr/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/stats-incr-pcorr/tree/esm
[esm-readme]: https://github.com/stdlib-js/stats-incr-pcorr/blob/esm/README.md
